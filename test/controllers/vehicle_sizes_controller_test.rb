...
class VehicleSizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_size" do
    assert_difference('VehicleSize.count') do
      post vehicle_sizes_url, params: { vehicle_size: { vehicle_size_code: @vehicle_size.vehicle_size_code, vehicle_size_description: @vehicle_size.vehicle_size_description, vehicle_size_name: @vehicle_size.vehicle_size_name } }
    end
  ...
  test "should update vehicle_size" do
    patch vehicle_size_url(@vehicle_size), params: { vehicle_size: { vehicle_size_code: @vehicle_size.vehicle_size_code, vehicle_size_description: @vehicle_size.vehicle_size_description, vehicle_size_name: @vehicle_size.vehicle_size_name } }
